...
namespace GenshinImpactMovementSystem
{
    public class PlayerGroundedState : PlayerMovementState {
        ...
        public override void Enter() {
            ...
            StartAnimation(stateMachine.Player.AnimationData.GroundedParametrerHash);
        ...
        public override void Exit() {
            ...
            StopAnimation(stateMachine.Player.AnimationData.GroundedParametrerHash);
        }
        ...
        private void Float() {
            ...
            //Debug.DrawRay(hit.point, capsuleColliderCenterInWorldSpace, Color.red);
        }
        ...
        private bool IsThereGroundUnderneath() {
            ...
            Collider[] overlappedGroundColliders = Physics.OverlapBox(groundColliderCenterInWorldSpace, 
                stateMachine.Player.ColliderUtility.TriggerColliderData.GroundCheckColliderExtens, 
        ...
        protected override void OnContactWithGroundExited(Collider collider) {
            ...
            Vector3 capsuleColliderCenterInWorldSpace = stateMachine.Player.ColliderUtility.CapsuleColliderData.Collider.bounds.center;
            Ray downsRayFromCapsuleBottom = new Ray(capsuleColliderCenterInWorldSpace - 
                stateMachine.Player.ColliderUtility.CapsuleColliderData.ColliderVerticalExtens, Vector3.down);

            if (!Physics.Raycast(downsRayFromCapsuleBottom, out _, movementData.GroundToFallRayDistance, 
                stateMachine.Player.LayerData.GroundLayer, QueryTriggerInteraction.Ignore)) {
